...
typedef enum {
    ...
    RC_ZD_FISH_4,
    RC_ZD_FISH_5,
    RC_SIGN_GORON_CITY_ROLLING_GORON,
    RC_SIGN_GERUDO_FORTRESS_HORSEBACK_ARCHERY,
    RC_SIGN_GERUDO_FORTRESS_TRAINING_GROUNDS,
    RC_SIGN_GERUDO_FORTRESS_WASTELAND_WARNING,
    RC_SIGN_FOREST_STAGE,
    RC_SIGN_DEATH_MOUNTAIN_TRAIL_START,
    RC_SIGN_DEATH_MOUNTAIN_TRAIL_DODONGOS_CAVERN_ENTRANCE,
    RC_SIGN_DEATH_MOUNTAIN_TRAIL_GORON_CITY_ENTRANCE,
    RC_SIGN_DEATH_MOUNTAIN_TRAIL_BOMB_FLOWER,
    RC_SIGN_HYRULE_CASTLE_DEAD_END,
    RC_SIGN_ZORAS_FOUNTAIN,
    RC_SIGN_SHOOTING_GALLERY,
    RC_SIGN_ZORAS_DOMAIN_WELCOME,
    RC_SIGN_ZORAS_DOMAIN_SHOP,
    RC_SIGN_ZORAS_DOMAIN_THRONE_ROOM,
    RC_SIGN_GERUDO_VALLEY_NO_DIVING,
    RC_SIGN_LAKE_HYLIA_LABORATORY,
    RC_SIGN_GRAVEYARD_GRAVEDIGGING_TOUR_CHILD,
    RC_SIGN_GRAVEYARD_GRAVEDIGGING_TOUR_ADULT,
    RC_SIGN_KAKARIKO_VILLAGE_WELL,
    RC_SIGN_KAKARIKO_VILLAGE_DEATH_MOUNTAIN_GATE,
    RC_SIGN_KOKIRI_FOREST_EXIT,
    RC_SIGN_KOKIRI_FOREST_HOLE_OF_Z,
    RC_SIGN_KOKIRI_FOREST_Z_TARGET_TUTORIAL,
    RC_SIGN_KOKIRI_FOREST_CUT_GRASS,
    RC_SIGN_KOKIRI_FOREST_THRUST_ATTACK,
    RC_SIGN_KOKIRI_FOREST_LINKS_HOUSE,
    RC_SIGN_KOKIRI_FOREST_STEPPING_STONE,
    RC_SIGN_KOKIRI_FOREST_DEKU_TREE_MEADOW,
    RC_SIGN_KOKIRI_FOREST_SWORD,
    RC_SIGN_LAKE_HYLIA_FISHING_CHILD,
    RC_SIGN_LAKE_HYLIA_FISHING_ADULT,
    RC_MAX
} RandomizerCheck;
...
typedef enum {
    ...
    // Signs
    RHT_SIGN_GORON_CITY_ROLLING_GORON,
    RHT_SIGN_GERUDO_FORTRESS_HORSEBACK_ARCHERY,
    RHT_SIGN_GERUDO_FORTRESS_TRAINING_GROUNDS,
    RHT_SIGN_GERUDO_FORTRESS_WASTELAND_WARNING,
    RHT_SIGN_FOREST_STAGE,
    RHT_SIGN_DEATH_MOUNTAIN_TRAIL_START,
    RHT_SIGN_DEATH_MOUNTAIN_TRAIL_DODONGOS_CAVERN_ENTRANCE,
    RHT_SIGN_DEATH_MOUNTAIN_TRAIL_GORON_CITY_ENTRANCE,
    RHT_SIGN_DEATH_MOUNTAIN_TRAIL_BOMB_FLOWER,
    RHT_SIGN_HYRULE_CASTLE_DEAD_END,
    RHT_SIGN_ZORAS_FOUNTAIN,
    RHT_SIGN_SHOOTING_GALLERY,
    RHT_SIGN_ZORAS_DOMAIN_WELCOME,
    RHT_SIGN_ZORAS_DOMAIN_SHOP,
    RHT_SIGN_ZORAS_DOMAIN_THRONE_ROOM,
    RHT_SIGN_GERUDO_VALLEY_NO_DIVING,
    RHT_SIGN_LAKE_HYLIA_LABORATORY,
    RHT_SIGN_GRAVEYARD_GRAVEDIGGING_TOUR_CHILD,
    RHT_SIGN_GRAVEYARD_GRAVEDIGGING_TOUR_ADULT,
    RHT_SIGN_KAKARIKO_VILLAGE_WELL,
    RHT_SIGN_KAKARIKO_VILLAGE_DEATH_MOUNTAIN_GATE,
    RHT_SIGN_KOKIRI_FOREST_EXIT,
    RHT_SIGN_KOKIRI_FOREST_HOLE_OF_Z,
    RHT_SIGN_KOKIRI_FOREST_Z_TARGET_TUTORIAL,
    RHT_SIGN_KOKIRI_FOREST_CUT_GRASS,
    RHT_SIGN_KOKIRI_FOREST_THRUST_ATTACK,
    RHT_SIGN_KOKIRI_FOREST_LINKS_HOUSE,
    RHT_SIGN_KOKIRI_FOREST_STEPPING_STONE,
    RHT_SIGN_KOKIRI_FOREST_DEKU_TREE_MEADOW,
    RHT_SIGN_KOKIRI_FOREST_SWORD,
    RHT_SIGN_LAKE_HYLIA_FISHING_CHILD,
    RHT_SIGN_LAKE_HYLIA_FISHING_ADULT,
    // Items
    RHT_KOKIRI_SWORD,
    RHT_MASTER_SWORD,
    RHT_GIANTS_KNIFE,
