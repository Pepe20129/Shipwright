...
void AreaTable_Init_HyruleField() {
  ...
  areaTable[RR_LAKE_HYLIA] = Area("Lake Hylia", "Lake Hylia", RA_LAKE_HYLIA, DAY_NIGHT_CYCLE, {
                  ...
                  LOCATION(RC_SIGN_LAKE_HYLIA_LABORATORY, logic->CanReadSigns),
                }, {
                  //Exits
                  Entrance(RR_HYRULE_FIELD,          {[]{return true;}}),
  ...
  areaTable[RR_LH_FISHING_HOLE] = Area("LH Fishing Hole", "LH Fishing Hole", RA_NONE, DAY_NIGHT_CYCLE, {}, {
                  ...
                  LOCATION(RC_SIGN_LAKE_HYLIA_FISHING_CHILD, logic->CanReadSigns && logic->IsChild),
                  LOCATION(RC_SIGN_LAKE_HYLIA_FISHING_ADULT, logic->CanReadSigns && logic->IsAdult),
                }, {
                  //Exits
