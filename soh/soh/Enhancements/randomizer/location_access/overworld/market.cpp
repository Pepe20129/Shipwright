...
void RegionTable_Init_Market() {
    ...
    areaTable[RR_MARKET_TREASURE_CHEST_GAME] = Region("Market Treasure Chest Game", SCENE_TREASURE_BOX_SHOP, {}, {
        ...
        LOCATION(RC_MARKET_TREASURE_CHEST_GAME_SHOPKEEPER_ITEM, logic->HasItem(RG_CHILD_WALLET) && ctx->GetOption(RSK_SHUFFLE_CHEST_MINIGAME)),
        LOCATION(RC_MARKET_TREASURE_CHEST_GAME_LEFT_1,          logic->HasItem(RG_CHILD_WALLET) && (ctx->GetOption(RSK_SHUFFLE_CHEST_MINIGAME) ? logic->SmallKeys(RR_MARKET_TREASURE_CHEST_GAME, 1) : logic->CanUse(RG_LENS_OF_TRUTH))),
        LOCATION(RC_MARKET_TREASURE_CHEST_GAME_RIGHT_1,         logic->HasItem(RG_CHILD_WALLET) && (ctx->GetOption(RSK_SHUFFLE_CHEST_MINIGAME) ? logic->SmallKeys(RR_MARKET_TREASURE_CHEST_GAME, 1) : logic->CanUse(RG_LENS_OF_TRUTH))),
        LOCATION(RC_MARKET_TREASURE_CHEST_GAME_LEFT_2,          logic->HasItem(RG_CHILD_WALLET) && (ctx->GetOption(RSK_SHUFFLE_CHEST_MINIGAME) ? logic->SmallKeys(RR_MARKET_TREASURE_CHEST_GAME, 2) : logic->CanUse(RG_LENS_OF_TRUTH))),
        LOCATION(RC_MARKET_TREASURE_CHEST_GAME_RIGHT_2,         logic->HasItem(RG_CHILD_WALLET) && (ctx->GetOption(RSK_SHUFFLE_CHEST_MINIGAME) ? logic->SmallKeys(RR_MARKET_TREASURE_CHEST_GAME, 2) : logic->CanUse(RG_LENS_OF_TRUTH))),
        LOCATION(RC_MARKET_TREASURE_CHEST_GAME_LEFT_3,          logic->HasItem(RG_CHILD_WALLET) && (ctx->GetOption(RSK_SHUFFLE_CHEST_MINIGAME) ? logic->SmallKeys(RR_MARKET_TREASURE_CHEST_GAME, 3) : logic->CanUse(RG_LENS_OF_TRUTH))),
        LOCATION(RC_MARKET_TREASURE_CHEST_GAME_RIGHT_3,         logic->HasItem(RG_CHILD_WALLET) && (ctx->GetOption(RSK_SHUFFLE_CHEST_MINIGAME) ? logic->SmallKeys(RR_MARKET_TREASURE_CHEST_GAME, 3) : logic->CanUse(RG_LENS_OF_TRUTH))),
        LOCATION(RC_MARKET_TREASURE_CHEST_GAME_LEFT_4,          logic->HasItem(RG_CHILD_WALLET) && (ctx->GetOption(RSK_SHUFFLE_CHEST_MINIGAME) ? logic->SmallKeys(RR_MARKET_TREASURE_CHEST_GAME, 4) : logic->CanUse(RG_LENS_OF_TRUTH))),
        LOCATION(RC_MARKET_TREASURE_CHEST_GAME_RIGHT_4,         logic->HasItem(RG_CHILD_WALLET) && (ctx->GetOption(RSK_SHUFFLE_CHEST_MINIGAME) ? logic->SmallKeys(RR_MARKET_TREASURE_CHEST_GAME, 4) : logic->CanUse(RG_LENS_OF_TRUTH))),
        LOCATION(RC_MARKET_TREASURE_CHEST_GAME_LEFT_5,          logic->HasItem(RG_CHILD_WALLET) && (ctx->GetOption(RSK_SHUFFLE_CHEST_MINIGAME) ? logic->SmallKeys(RR_MARKET_TREASURE_CHEST_GAME, 5) : logic->CanUse(RG_LENS_OF_TRUTH))),
        LOCATION(RC_MARKET_TREASURE_CHEST_GAME_RIGHT_5,         logic->HasItem(RG_CHILD_WALLET) && (ctx->GetOption(RSK_SHUFFLE_CHEST_MINIGAME) ? logic->SmallKeys(RR_MARKET_TREASURE_CHEST_GAME, 5) : logic->CanUse(RG_LENS_OF_TRUTH))),
        LOCATION(RC_MARKET_TREASURE_CHEST_GAME_REWARD,          logic->HasItem(RG_CHILD_WALLET) && (ctx->GetOption(RSK_SHUFFLE_CHEST_MINIGAME) ? logic->SmallKeys(RR_MARKET_TREASURE_CHEST_GAME, 6) : logic->CanUse(RG_LENS_OF_TRUTH))),
    }, {
        //Exits
        Entrance(RR_THE_MARKET, []{return true;}),
    });
