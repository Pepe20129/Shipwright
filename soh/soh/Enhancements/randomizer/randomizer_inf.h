...
typedef enum {
    ...
    RAND_INF_SIGN_GORON_CITY_ROLLING_GORON,
    RAND_INF_SIGN_GERUDO_FORTRESS_HORSEBACK_ARCHERY,
    RAND_INF_SIGN_GERUDO_FORTRESS_TRAINING_GROUNDS,
    RAND_INF_SIGN_GERUDO_FORTRESS_WASTELAND_WARNING,
    RAND_INF_SIGN_FOREST_STAGE,
    RAND_INF_SIGN_DEATH_MOUNTAIN_TRAIL_START,
    RAND_INF_SIGN_DEATH_MOUNTAIN_TRAIL_DODONGOS_CAVERN_ENTRANCE,
    RAND_INF_SIGN_DEATH_MOUNTAIN_TRAIL_GORON_CITY_ENTRANCE,
    RAND_INF_SIGN_DEATH_MOUNTAIN_TRAIL_BOMB_FLOWER,
    RAND_INF_SIGN_HYRULE_CASTLE_DEAD_END,
    RAND_INF_SIGN_ZORAS_FOUNTAIN,
    RAND_INF_SIGN_SHOOTING_GALLERY,
    RAND_INF_SIGN_ZORAS_DOMAIN_WELCOME,
    RAND_INF_SIGN_ZORAS_DOMAIN_SHOP,
    RAND_INF_SIGN_ZORAS_DOMAIN_THRONE_ROOM,
    RAND_INF_SIGN_GERUDO_VALLEY_NO_DIVING,
    RAND_INF_SIGN_LAKE_HYLIA_LABORATORY,
    RAND_INF_SIGN_GRAVEYARD_GRAVEDIGGING_TOUR_CHILD,
    RAND_INF_SIGN_GRAVEYARD_GRAVEDIGGING_TOUR_ADULT,
    RAND_INF_SIGN_KAKARIKO_VILLAGE_WELL,
    RAND_INF_SIGN_KAKARIKO_VILLAGE_DEATH_MOUNTAIN_GATE,
    RAND_INF_SIGN_KOKIRI_FOREST_EXIT,
    RAND_INF_SIGN_KOKIRI_FOREST_HOLE_OF_Z,
    RAND_INF_SIGN_KOKIRI_FOREST_Z_TARGET_TUTORIAL,
    RAND_INF_SIGN_KOKIRI_FOREST_CUT_GRASS,
    RAND_INF_SIGN_KOKIRI_FOREST_THRUST_ATTACK,
    RAND_INF_SIGN_KOKIRI_FOREST_LINKS_HOUSE,
    RAND_INF_SIGN_KOKIRI_FOREST_STEPPING_STONE,
    RAND_INF_SIGN_KOKIRI_FOREST_DEKU_TREE_MEADOW,
    RAND_INF_SIGN_KOKIRI_FOREST_SWORD,
    RAND_INF_SIGN_LAKE_HYLIA_FISHING_CHILD,
    RAND_INF_SIGN_LAKE_HYLIA_FISHING_ADULT,
