...
const std::vector<FlagTable> flagTables = {
   ...
   { "Randomizer Inf Flags", RANDOMIZER_INF, 0x09, {
        ...
        { RAND_INF_TRIAL_SHUFFLE_LIGHT_TRIAL, "RAND_INF_TRIAL_SHUFFLE_LIGHT_TRIAL" },
        { RAND_INF_TRIAL_SHUFFLE_FOREST_TRIAL, "RAND_INF_TRIAL_SHUFFLE_FOREST_TRIAL" },
        { RAND_INF_TRIAL_SHUFFLE_FIRE_TRIAL, "RAND_INF_TRIAL_SHUFFLE_FIRE_TRIAL" },
        { RAND_INF_TRIAL_SHUFFLE_WATER_TRIAL, "RAND_INF_TRIAL_SHUFFLE_WATER_TRIAL" },
        { RAND_INF_TRIAL_SHUFFLE_SPIRIT_TRIAL, "RAND_INF_TRIAL_SHUFFLE_SPIRIT_TRIAL" },
        { RAND_INF_TRIAL_SHUFFLE_SHADOW_TRIAL, "RAND_INF_TRIAL_SHUFFLE_SHADOW_TRIAL" }
    } },
};
