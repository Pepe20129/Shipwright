...
void SaveManager::InitFileMaxed() {
    ...
    Flags::ENTERED_HYRULE_FIELD.Set();
    Flags::ENTERED_DEATH_MOUNTAIN_TRAIL.Set();
    Flags::ENTERED_KAKARIKO_VILLAGE.Set();
    Flags::ENTERED_ZORAS_DOMAIN.Set();
    Flags::ENTERED_HYRULE_CASTLE.Set();
    Flags::ENTERED_GORON_CITY.Set();
    Flags::ENTERED_TEMPLE_OF_TIME.Set();
    Flags::ENTERED_DEKU_TREE.Set();
    Flags::ENTERED_DODONGOS_CAVERN.Set();
    Flags::ENTERED_LAKE_HYLIA.Set();
    Flags::ENTERED_GERUDO_VALLEY.Set();
    Flags::ENTERED_GERUDOS_FORTRESS.Set();
    Flags::ENTERED_LON_LON_RANCH.Set();
    Flags::ENTERED_JABU_JABUS_BELLY.Set();
    Flags::ENTERED_GRAVEYARD.Set();
    Flags::ENTERED_ZORAS_FOUNTAIN.Set();
    Flags::ENTERED_DESERT_COLOSSUS.Set();
    Flags::ENTERED_DEATH_MOUNTAIN_CRATER.Set();
    Flags::ENTERED_GANONS_CASTLE_EXTERIOR.Set();
