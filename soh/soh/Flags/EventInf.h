...
namespace Flags {
    ...
    const Flag EVENTINF_UNKNOWN_02 = Flag::FromEventInf(0x02);
    const Flag EVENTINF_UNKNOWN_05 = Flag::FromEventInf(0x05);
    ...
    const Flag EVENTINF_UNKNOWN_0A = Flag::FromEventInf(0x0A);
