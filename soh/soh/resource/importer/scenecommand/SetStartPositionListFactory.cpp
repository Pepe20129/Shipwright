...
SetStartPositionListFactory::ReadResourceXML(std::shared_ptr<ResourceInitData> initData, tinyxml2::XMLElement *reader) {
    auto resource = std::make_shared<SetStartPositionList>(initData);
    std::shared_ptr<ResourceVersionFactory> factory = nullptr;
...
void LogStartPositionListAsXML(std::shared_ptr<IResource> resource) {
    std::shared_ptr<SetStartPositionList> setStartPositionList = std::static_pointer_cast<SetStartPositionList>(resource);
