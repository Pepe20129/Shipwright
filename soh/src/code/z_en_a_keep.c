...
const ActorProfile En_A_Obj_InitVars = {
    ACTOR_EN_A_OBJ,
    ACTORCAT_PROP,
    FLAGS,
...
void EnAObj_Init(Actor* thisx, PlayState* play) {
    ...
    switch (thisx->params) {
        ...
        case A_OBJ_SIGNPOST_ARROW:
            ...
            // clang-format off
            thisx->flags |= ACTOR_FLAG_ATTENTION_ENABLED | ACTOR_FLAG_FRIENDLY; thisx->lockOnArrowOffset = 500.0f;
            // clang-format on
...
void EnAObj_BoulderFragment(EnAObj* this, PlayState* play) {
    ...
    if (this->dyna.actor.speed != 0.0f && this->dyna.actor.bgCheckFlags & 0x8) {
