...
const ActorProfile Bg_Mori_Hashigo_InitVars = {
...
static InitChainEntry sInitChainClasp[] = {
    ICHAIN_F32(cullingVolumeDistance, 1000, ICHAIN_CONTINUE),  ICHAIN_F32(cullingVolumeScale, 400, ICHAIN_CONTINUE),
    ICHAIN_F32(cullingVolumeDownward, 1000, ICHAIN_CONTINUE), ICHAIN_U8(attentionRangeType, 3, ICHAIN_CONTINUE),
