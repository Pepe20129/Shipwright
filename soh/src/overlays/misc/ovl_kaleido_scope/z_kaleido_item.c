...
void KaleidoScope_DrawAmmoCount(PauseContext* pauseCtx, GraphicsContext* gfxCtx, s16 item, int slot) {
    ...
    if (i != 0) {
        gSPVertex(POLY_KAL_DISP++, &pauseCtx->itemVtx[((IS_CYAN || CVarGetInteger("gEnhancements.BetterAmmoRendering", 0) ? sAllAmmoVtxOffset[slot] : sAmmoVtxOffset[slot]) + 31) * 4], 4, 0);
    ...
    gSPVertex(POLY_KAL_DISP++, &pauseCtx->itemVtx[((IS_CYAN || CVarGetInteger("gEnhancements.BetterAmmoRendering", 0) ? sAllAmmoVtxOffset[slot] : sAmmoVtxOffset[slot]) + 32) * 4], 4, 0);
...
void KaleidoScope_DrawItemSelect(PlayState* play) {
    ...
    u8 gBetterAmmoRendering = IS_CYAN || CVarGetInteger("gEnhancements.BetterAmmoRendering", 0);
