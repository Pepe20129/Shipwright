...
#define CHECK_AGE_REQ_SLOT(slotIndex) (CVarGetInteger(CVAR_CHEAT("TimelessEquipment"), 0) || (IS_CYAN ? (gCyanSlotAgeReqs[slotIndex] == AGE_REQ_NONE || gCyanSlotAgeReqs[slotIndex] == gSaveContext.linkAge) : ((gSlotAgeReqs[slotIndex] == AGE_REQ_NONE) || gSlotAgeReqs[slotIndex] == ((void)0, gSaveContext.linkAge))))
#define CHECK_AGE_REQ_ITEM(itemIndex) (CVarGetInteger(CVAR_CHEAT("TimelessEquipment"), 0) || (IS_CYAN ? (gCyanItemAgeReqs[itemIndex] == AGE_REQ_NONE || gCyanItemAgeReqs[itemIndex] == gSaveContext.linkAge) : ((gItemAgeReqs[itemIndex] == AGE_REQ_NONE) || (gItemAgeReqs[itemIndex] == gSaveContext.linkAge))))
