...
s32 Player_SetCsAction(PlayState* play, Actor* csActor, u8 csMode);
s32 Player_SetCsActionWithHaltedActors(PlayState* play, Actor* csActor, u8 arg2);
...
s32 Actor_CullingVolumeTest(PlayState* play, Actor* actorB, Vec3f* projPos, f32 projW);
